 ...
 * The tool takes "balloonWeatherInfoFile", "command" as command line arguments 
 * ej: java -jar target/parser-jar-with-dependencies.jar --command=[meanTemp],[maxTemp],[minTemp],[observations],[totalDistance],[ALL]
 *         --balloonWeatherInfoFile=/home/escanor/Documents/examenes/access.log
 */
public class BalloonWeatherParserService {
	...
	private static void verifyCommands(Set<String> commands) throws CommandNotFoundException{
		...
		if(commands.isEmpty()) {
			throw new CommandNotFoundException("The commands sent in the request do not match to any command registered in this tool: ");
		}
	}
